  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* Hero — same treatment as main page */}
        <section className="relative min-h-[60vh] flex items-center pt-24 pb-16 sm:pt-28 sm:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
              <div>
                ...
                <h3 className="font-semibold text-slate-900">Proven strategies</h3>
                <p className="mt-1 text-sm text-slate-600">Step-by-step playbooks that work for real agencies.</p>
              </div>
              <div>
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-amber-100 text-amber-600 mb-3">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <h3 className="font-semibold text-slate-900">$1000 per client</h3>
                <p className="mt-1 text-sm text-slate-600">Learn how to charge premium and keep 100% of the profits.</p>
              </div>
              <div>
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-amber-100 text-amber-600 mb-3">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <h3 className="font-semibold text-slate-900">AI tools & support</h3>
                <p className="mt-1 text-sm text-slate-600">Leverage AI solutions and get guidance along the way.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <main className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto">
            <motion.section
              ...
              className="relative rounded-3xl bg-white border-2 border-amber-500/20 shadow-xl shadow-amber-500/5 p-8 sm:p-10 md:p-12"
            >
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <span className="inline-block px-4 py-1.5 rounded-full bg-red-600 text-white text-sm font-semibold">
                  Free workshop
                </span>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-10">
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <input
                    ...
                    className="flex-1 min-w-0 px-5 py-3.5 rounded-xl border-2 border-slate-200 bg-slate-50/50 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 disabled:opacity-60 transition-colors"
                  />
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="sm:w-auto px-8 py-3.5 rounded-xl font-semibold text-white bg-red-600 hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed transition-all shadow-lg shadow-red-600/25 hover:shadow-red-600/30 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-white"
                  >
            ...
            <p className="mt-10 text-center">
              <Link href="/" className="text-amber-600 hover:text-amber-700 font-medium inline-flex items-center gap-1">
        ...
        {/* Trust line */}
        <section className="py-10 px-4 sm:px-6 lg:px-8 bg-slate-50 border-t border-slate-200">
